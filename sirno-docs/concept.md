...
Concepts keep intent portable across the monograph, entries, and code.
...
Some concepts are broad, such as the Sirno store or concept-driven development.
...
Sirno supplies the relation fields and id rules.
