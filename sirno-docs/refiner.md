...
The relation preserves the reason that a local choice exists.
...
From the broad entry, generated or queried relations can reveal the entries that elaborate it.
