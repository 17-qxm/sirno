...
For example, `concept`, `narrative`, `relation`, and `direction` can all be entries.
...
The same query, check, footer, and relation rules apply to entries about vocabulary
